...
mod tests {
	...
	impl super::Trait for Test {
		...
		type ExternalOrigin = EnsureSignedBy<Two, u64, Self::Doughnut>;
		type ExternalMajorityOrigin = EnsureSignedBy<Three, u64, Self::Doughnut>;
		type ExternalDefaultOrigin = EnsureSignedBy<One, u64, Self::Doughnut>;
		type FastTrackOrigin = EnsureSignedBy<Five, u64, Self::Doughnut>;
		type CancellationOrigin = EnsureSignedBy<Four, u64, Self::Doughnut>;
		type VetoOrigin = EnsureSignedBy<OneToFive, u64, Self::Doughnut>;
