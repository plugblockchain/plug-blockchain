...
pub trait Trait: 'static + Eq + Clone {
	...
	type Origin:
		Into<Result<RawOrigin<Self::AccountId, Self::Doughnut>, Self::Origin>>
		+ From<RawOrigin<Self::AccountId, Self::Doughnut>> + MaybeDoughnutRef<Doughnut=Self::Doughnut>
		+ Clone;
...
pub fn ensure_signed<OuterOrigin, AccountId, Doughnut>(o: OuterOrigin) -> Result<AccountId, BadOrigin>
